...
const ids = ["react-architecture", "react-quality-safeguards", "react-state-data-integration", "react-testing"] as const;
...
test("React skill contracts keep constrained metadata, ordered sections, taxonomy, and adaptive safeguards", async () => {
  for (const id of ids) {
